...
- [ ] custom winbar
  - `$WS/foo/bar/name.ext [M]`
  - mini_statusline without filename
- [ ] check: https://github.com/Orange-OpenSource/hurl
...
# https://github.com/philopence/nix-configuration
...
# (optional) Backup:
$ cp -r /mnt/etc/nixos /mnt/nix/persistent/etc/nixos
```
