...
let
  ...
  hash = {
    ...
    # aarch64-linux = "sha256-UBfVqgeLZUycfasO/eU39XcX0lnt9QGhUKNKF/fBH5A=";
    # x86_64-darwin = "sha256-V0Xv0lTS2PSnA0S3r0rS0q33RPhDTzZh8YGUAuUsvk4=";
    # aarch64-darwin = "sha256-z1cZ6xmP25iPezeLpz4xRh7czgx1JLwsYwGAEUA6//I=";
  }.${system} or throwSystem;
